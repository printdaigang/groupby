...
book3 = Book(title=u"编译原理（原书第2版）", subtitle=u"原理、技术与工具",
             ...
             tags=u"计算机/编译原理", summary=u"""* 本书全面、深入地探讨了编译器设计方面的重要主题，包括词法分析、语法分析、语法制导定义和语法制导翻译、运行时刻环境、目标代码生成、代码优化技术、并行性检测以及过程间分析技术，并在相关章节中给出大量的实例。与上一版相比，本书进行了全面的修订，涵盖了编译器开发方面的最新进展。每章中都提供了大量的系统及参考文献。
...
book4 = Book(title=u"深入理解计算机系统", author="Randal E.Bryant / David O'Hallaron", isbn="9787111321330",
             tags=u"计算机/计算机系统", summary=u"""* 本书从程序员的视角详细阐述计算机系统的本质概念，并展示这些概念如何实实在在地影响应用程序的正确性、性能和实用性。全书共12章，主要内容包括信息的表示和处理、程序的机器级表示、处理器体系结构、优化程序性能、存储器层次结构、链接、异常控制流、虚拟存储器、系统级I/O、网络编程、并发编程等。书中提供大量的例子和练习，并给出部分答案，有助于读者加深对正文所述概念和知识的理解。
...
book5 = Book(title=u"果壳中的C#", subtitle=u"C#5.0权威指南", author=u"阿坝哈瑞 (Joseph Albahari) / 阿坝哈瑞 (Ben Albahari)",
             isbn="9787517010845", tags=u"计算机/程序设计/C#", summary=u"""* 《果壳中的c#——c#5.0权威指南》是一本c＃5.0的权威技术指南，也是第一本中文版c＃5.0的学习资料。本书通过26章的内容，系统、全面、细致地讲解了c#5.0从基础知识到各种高级特性的命令、语法和用法。本书的讲解深入浅出，同时为每一个知识点都专门设计了贴切、简单、易懂的学习案例，从而可以帮助读者准确地理解知识点的含义并快速地学以致用。本书与之前的c#4.0版本相比，还新增了丰富的并发、异步、动态编程、代码精练、安全、com交互等高级特性相关的内容。
...
book6 = Book(title=u"算法导论（原书第2版）", author="Thomas H.Cormen / Charles E.Leiserson / Ronald L.Rivest / Clifford Stein",
             isbn="9787111187776", tags=u"计算机/算法",
