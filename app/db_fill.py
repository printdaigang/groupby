...
book1 = Book(title=u"Flask Web 开发", subtitle=u"基于Python的Web应用开发框架", author=u"Miguel Grinberg", isbn='9787115373991',
             tags=u"计算机/程序设计/Web开发", image='http://img3.douban.com/lpic/s27906700.jpg',
             summary=u"""
...
book2 = Book(title=u"STL源码剖析", subtitle=u"庖丁解牛 恢恢乎游刃有余", author=u"侯捷", isbn='9787560926995',
             tags=u"计算机/程序设计/C++", image='http://img3.doubanio.com/lpic/s1092076.jpg',
...
book3 = Book(title=u"编译原理（原书第2版）", subtitle=u"原理、技术与工具",
             ...
             tags=u"计算机/编译原理", image='http://img3.douban.com/lpic/s3392161.jpg',
...
book4 = Book(title=u"深入理解计算机系统", author="Randal E.Bryant / David O'Hallaron", isbn="9787111321330",
             tags=u"计算机/计算机系统", image='http://img3.douban.com/lpic/s4510534.jpg',
...
book5 = Book(title=u"果壳中的C#", subtitle=u"C#5.0权威指南", author=u"阿坝哈瑞 (Joseph Albahari) / 阿坝哈瑞 (Ben Albahari)",
             isbn="9787517010845", tags=u"计算机/程序设计/C#", image='http://img3.douban.com/lpic/s28152290.jpg',
...
book6 = Book(title=u"算法导论（原书第2版）", author="Thomas H.Cormen / Charles E.Leiserson / Ronald L.Rivest / Clifford Stein",
             isbn="9787111187776", tags=u"计算机/算法", image='http://img3.doubanio.com/lpic/s1959967.jpg',
